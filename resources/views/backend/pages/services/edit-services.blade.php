...
@section('title', 'edit new services')
@section('content')
                    ...
                    <div class="card-body">
                        <div class="border p-4 rounded">
                            <div class="card-title d-flex align-items-center">
                                <div><i class="bx bxs-edit me-1 font-22 text-info"></i>
                                </div>
                                <h5 class="mb-0 text-info">Edit New Services</h5>
                            </div>
                            <hr />
                            <form action="{{ route('services.update', $services->id) }}" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    is-invalid
                                  @enderror"
                                            id="title" name="title" value="{{ $services->title }}">
                                        @error('title')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="details" id="details" rows="3"
                                            ...
                                            is-invalid
                                          @enderror"
                                            placeholder="enter services details..">{{ $services->details }}</textarea>
                                        @error('details')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
