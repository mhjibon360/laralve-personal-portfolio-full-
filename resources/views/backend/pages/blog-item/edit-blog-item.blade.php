                ...
                <div class="card border-top border-0 border-4 border-info">
                    <div class="card-body">
                        <div class="border p-4 rounded">
                            ...
                            <hr />
                            <form action="{{ route('blog-item.update', $blog->id) }}" method="post"
                                ...
                                <div class="my-3">
                                    ...
                                    is-invalid
                                  @enderror"
                                        id="title" name="title" placeholder="enter title" value="{{ $blog->title }}">
                                    @error('title')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="my-3">
                                  ...
                                  is-invalid
                                @enderror"
                                        placeholder="write your small details..">{{ $blog->details }}</textarea>
                                    @error('details')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
